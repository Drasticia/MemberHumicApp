...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [computer, logo, notebook];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/HHumic.png
  AssetGenImage get hHumic => const AssetGenImage('assets/images/HHumic.png');

  /// File path: assets/images/group.png
  AssetGenImage get group => const AssetGenImage('assets/images/group.png');

  /// File path: assets/images/qrHUMIC.png
  AssetGenImage get qrHUMIC => const AssetGenImage('assets/images/qrHUMIC.png');

  /// List of all assets
  List<AssetGenImage> get values => [hHumic, group, qrHUMIC];
}
